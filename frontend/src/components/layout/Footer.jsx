...
import { Github, Twitter, Facebook, Mail, Heart, TrendingUp } from "lucide-react"
    ...
    <footer className="bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 mt-12">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center md:text-left">
          ...
          <div className="col-span-1 md:col-span-2 ">
            <div className="flex items-center justify-center md:justify-start space-x-2 mb-4 ">
              <div className="w-16 h-16 bg-gradient-to-r from-primary-500 to-primary-600 rounded-lg flex items-center justify-center">
                <div className="w-16 h-16 bg-gradient-to-r  rounded-xl flex items-center justify-center overflow-hidden">
                  <img
                    src="/iconweb.png" 
                    alt="Web Icon"
              ...
              <h3 className="font-playfair text-2xl font-bold text-gray-900 dark:text-white">VIETNAMCoin</h3>
            </div>
          ...
          {/* Quick Links + Support (responsive group) */}
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 col-span-1 md:col-span-2">
            {/* Quick Links */}
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="/" className="text-gray-600 dark:text-gray-400 hover:text-primary-600 transition-colors">{t.home}</a></li>
                <li><a href="#" className="text-gray-600 dark:text-gray-400 hover:text-primary-600 transition-colors">{t.markets}</a></li>
                <li><a href="#" className="text-gray-600 dark:text-gray-400 hover:text-primary-600 transition-colors">{t.portfolio}</a></li>
                <li><a href="#" className="text-gray-600 dark:text-gray-400 hover:text-primary-600 transition-colors">{t.news}</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="text-gray-600 dark:text-gray-400 hover:text-primary-600 transition-colors">{t.aboutUs}</a></li>
                <li><a href="#" className="text-gray-600 dark:text-gray-400 hover:text-primary-600 transition-colors">{t.contact}</a></li>
                <li><a href="#" className="text-gray-600 dark:text-gray-400 hover:text-primary-600 transition-colors">{t.privacy}</a></li>
                <li><a href="#" className="text-gray-600 dark:text-gray-400 hover:text-primary-600 transition-colors">{t.terms}</a></li>
              </ul>
            </div>
          </div>
        </div>
